...
public class PrticlNode implements ConfigurationSerializable {
    ...
    public static PrticlNode deserialize(int id,
        ...
        return new PrticlNode(id, name, repeatDelay, particleDensity, isEnabled, Particle.valueOf(nameOfParticleType), locationObj, createdBy);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ((PrticlNode) obj).getId() == this.getId();
    }
}